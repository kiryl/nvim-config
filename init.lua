...
require("nixCatsUtils.lazyCat").setup(nixCats.pawsible({ "allPlugins", "start", "lazy.nvim" }), {
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			local live_grep_cword = function()
			...
			vim.keymap.set("n", "<Leader>*", live_grep_cword, { desc = "[*] Grep current word" })
	...
	{ -- Highlight, edit, and navigate code
		...
		opts = {
			...
			indent = { enable = false, disable = { "c", "ruby" } },
		},
	},
...

	{
		...
		config = function()
			require("chatgpt").setup({
				api_key_cmd = "cat /home/kas/.cache/openai_api_key",
			})
